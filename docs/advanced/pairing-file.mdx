...
:::note
If you still recieve an error in SideStore, try restarting your iDevice and computer, then repeat the steps above. If you still have issues, please contact us on [Discord](https://discord.gg/side-store).
:::