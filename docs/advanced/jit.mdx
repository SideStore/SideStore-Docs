...
1. **Install StikDebug**
   Install StikDebug from the [Apple App Store](https://apps.apple.com/us/app/stikdebug/id6744045754). If you live in the EU, install StikDebug via AltStore PAL ([Install AltStore PAL](https://altstore.io/download), [Add StikDebug Source](https://intradeus.github.io/http-protocol-redirector?r=altstore-pal://source?url=https://stikdebug.xyz/apps.json)).

:::note Something nice- the VPN present in StikDebug is similar to the one used in SideStore, meaning you use it to install and refresh apps in SideStore as well, similar to LocalDevVPN.
:::
