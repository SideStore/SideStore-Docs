...
1. **Upload the Pairing File:**  
   Open and close StikDebug to build the app's folder in files, then import the same **pairing file** you use for SideStore using iloader. For more information on this process, see [here](https://github.com/StephenDev0/StikDebug-Guide/blob/main/pairing_file.md).
