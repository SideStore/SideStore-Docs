...
The SparseRestore exploit **only fully works on iOS/iPadOS versions between 17.0 and 18.1 beta 4 (not including 17.7.1 and 17.7.2)**. If you are not on these versions and it doesn't work, **please do not ask for support on this**. 
