...
This means that you must enter your Apple Account information in the settings tab to do the requested action.
...
This means SideStore couldn't launch a sideloaded app because you tapped "Cancel" on the "SideStore wants to open \[app]" alert, or because you still need to trust your Apple Account in Settings.
...
This means that the Apple Account credentials you used were invalid. Make sure the username and password are correct.

If you still have issues, you can also try creating a new Apple Account to use with SideStore.
...
This error means that the information used to authenticate your Apple Account is either expired or invalid. Make sure your computer's date and time are accurate and try again.

### (1102) Apple ID cannot be used for development.
`Apple.APIError`

You may need to agree to Apple’s Terms of Service on [developer.apple.com](https://developer.apple.com). If that doesn’t work, you can create a new “throwaway” Apple Account dedicated to sideloading.

### (-20101) Your account information was entered incorrectly.
`Apple.APIError`

This error means that the username or password used to authenticate your Apple Account is either expired or invalid. Make sure you've entered them both in correctly and that your computer's date and time are accurate.
