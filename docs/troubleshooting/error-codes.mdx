...
You do not appear to be connected to Wi-Fi and/or LocalDevVPN. SideStore cannot refresh or install applications without Wi-Fi and LocalDevVPN, ensure both are connected. If that doesn't work, [replace your pairing file using iloader](/docs/advanced/pairing-file).
