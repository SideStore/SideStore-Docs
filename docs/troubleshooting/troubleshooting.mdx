...
5. Create a brand new pairing file.
   - If none of the above worked it is very likely that the pairing file is corrupted. You can reference the documentation on how to create a new pairing file [here](installation/pairing-file). 
