...
1. **Change the Anisette Server:**
   ...
   - We advise you to try the "Macley" server first before the others, as it is one of the most stable.

2. **Host Your Own Anisette Server:**
   If you prefer, you can set up your own Anisette server. Detailed instructions for hosting an Anisette server are available in the official and can he found [here](https://docs.sidestore.io/docs/advanced/anisette).
