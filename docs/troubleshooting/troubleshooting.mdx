...
### Cannot start Debug Server
1. Ensure you are on iOS 17.4+
2. There are times when the Debug Server doesn't work. However, you can try [replacing your pairing file using iloader](/docs/advanced/pairing-file).
