...
2. Open iloader.
3. Sign in to an Apple Account (It doesn't need to be the account associated with the device).
...
11. Tap the "X DAYS" button to the right of SideStore to manually refresh it (X should show 7, it represents the number of days until an app's expiry).
