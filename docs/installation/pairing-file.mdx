...
:::warning
Caution, if you update or reset your iDevice, your pairing file will expire and you will need to generate a new one. This also occurs at random times. This is due to Apple's systems, and there is nothing we can do at this point to fix it.
:::
