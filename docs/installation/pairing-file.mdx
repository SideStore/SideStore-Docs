...
1. Ensure iTunes is installed from from Apple's website ([64-bit](https://apple.com/itunes/download/win64) or [32-bit](https://apple.com/itunes/download/win32)) (it should already be installed from setting up AltServer).
