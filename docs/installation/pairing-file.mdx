...
When using cloud storage, the file extension might change (usually to .txt or .mobiledevicepair). It is always recommended to zip your pairing file before transferring it. SideStore only accepts .mobiledevicepairing files.
:::
...
8. For best results, compress the file into a .zip folder. Then, **transfer the pairing file** to your iOS device using AirDrop, iCloud/One/Google Drive, email, or another method you prefer. 
