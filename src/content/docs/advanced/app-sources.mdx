...
This will allow you to set certain apps to only be available to your Patrons. Other similar capabilities to this will available to specify in the `userInfo` section in the future.
...
If you want to see the full JSON example file that was used throughout this tutorial, [here it is](/public/source-template.json).
