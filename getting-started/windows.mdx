...
Please make sure that on your machine the non-Microsoft Store versions of [iCloud](https://updates.cdn-apple.com/2020/windows/001-39935-20200911-1A70AA56-F448-11EA-8CC0-99D41950005E/iCloudSetup.exe) and [iTunes](https://support.apple.com/en-us/HT210384) are installed, if you are running Windows. Before you start, make sure to make sure is done in the [Prerequisites](Prerequisites), and that you have a [pairing file](pairing-file)!
...
5. Open SideStore, select your pairing file, and sign in with your Apple ID. When you finish, then follow the [post-install instructions](post-install).
