...
1. Stellen Sie sicher, dass Sie diese [Anleitung](/docs/installation/prerequisites) zur Einrichtung von iloader und Installation von SideStore befolgt haben.
