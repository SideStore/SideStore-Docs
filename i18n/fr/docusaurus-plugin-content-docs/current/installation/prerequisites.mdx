...
- Un ordinateur sous [Windows](/docs/installation/windows.mdx), [macOS](/docs/installation/mac.mdx) ou [Linux (Linux support is experimental)](/docs/installation/linux.mdx).
