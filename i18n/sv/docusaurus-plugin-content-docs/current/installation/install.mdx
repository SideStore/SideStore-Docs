...
Observera att om du uppdaterar eller nollställer din iDevice löper pairing-filen ut och du måste importera den igen via [den här guiden](/docs/advanced/pairing-file). Det kan även hända sporadiskt på grund av Apples mjukvara. 
