...
Din pairing-fil är korrupt. [Importera den igen med iloader](/sv/docs/advanced/pairing-fileg-file).
...
Du verkar inte vara ansluten till Wi-Fi och/eller StosVPN. SideStore kan inte installera eller uppdatera appar utan det. Om det inte hjälper, [importera pairing-filen igen](/sv/docs/advanced/pairing-file).
...
Säkerställ att både Wi-Fi och StosVPN är på. Om felet kvarstår, [importera pairing-filen på nytt](/sv/docs/advanced/pairing-file).
