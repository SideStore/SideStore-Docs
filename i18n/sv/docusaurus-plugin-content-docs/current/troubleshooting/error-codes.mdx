...
Den här sidan är inte helt uppdaterad i förhållande till hur SideStore fungerar, eftersom den bygger på AltStores sida om felkoder. Mycket stämmer fortfarande, men lita inte blint på den. Be gärna om hjälp i vår [Discord-server](https://dis.sidestore.io) vid behov.
