...
## Steg
1. Installera SparseBox. Det kan göras på flera sätt men i denna guide använder vi SideStore. Senaste versionen finns [här](https://github.com/khanhduytran0/SparseBox/releases/download/0.0.1/com.kdt.sparsebox_0.0.1.ipa).
