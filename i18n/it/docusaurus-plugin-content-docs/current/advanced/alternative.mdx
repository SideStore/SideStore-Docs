...
### WireGuard
:::note
La VPN WireGuard di SideStore **funziona solo su versioni di SideStore tra la 0.3.1-0.6.1 e dalla 0.6.3-nightly.4e6756d in poi** e non è consigliato se hai alternative disponibili come LocalDevVPN o StikDebug. Se non sei su queste versioni e non funziona, **non richiedere supporto**.
:::
