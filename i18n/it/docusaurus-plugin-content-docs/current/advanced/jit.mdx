...
1. **Installa StikDebug**
   Installa StikDebug dall'[App Store](https://apps.apple.com/us/app/stikdebug/id6744045754). Nota: non puoi eseguire il sideload di app con VPN se hai un account developer gratuito.

:::note Punto a favore- la VPN di StikDebug funziona nello stesso modo di quella di SideStore, puoi dunque usarla per installare e refreshare le app in SideStore, in modo simile a LocalDevVPN.
:::
