...
1. **Installa StikDebug**
   Installa StikDebug dall'[App Store](https://apps.apple.com/us/app/stikdebug/id6744045754). Se vivi nell'UE, installa StikDebug da AltStore PAL ([Installa AltStore PAL](https://altstore.io/download), [Aggiungi la repo StikDebug](https://intradeus.github.io/http-protocol-redirector?r=altstore-pal://source?url=https://stikdebug.xyz/apps.json)).
