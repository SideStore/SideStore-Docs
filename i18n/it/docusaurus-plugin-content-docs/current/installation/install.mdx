...
Attento, se aggiorni o formatti il tuo iDevice, il tuo pairing file scadrà e dovrai reimportarlo seguendo [questa guida](/fr/docs/advanced/pairing-file). Questo potrebbe accadere anche a random a causa di Apple.
