...
3. Autorizza l'"App Sviluppatore" sotto alla mail del tuo Account Apple.
...
7. Apri SideStore.
8. Accedi col tuo Account Apple.
9. Vai in "My Apps".
...
Se vuoi installare SideStore su un altro device con lo stesso ID Apple, segui [questi step](https://github.com/SideStore/SideStore/pull/1008#issue-3138680291).
