...
2. Apri iloader.
3. Accedi al tuo Account Apple (non è necessario che sia lo stesso associato al tuo dispositivo)
...
9. Vai in "My Apps".
10. Tocca sul bottone "X DAYS" alla destra di SideStore (X dovrebbe essere 7, corrisponde al numero di giorni rimanenti alla scadenza dell'app).
