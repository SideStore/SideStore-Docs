...
#### Soluzione
1. Se stai usando WireGuard o StosVPN, passa a LocalDevVPN o StikDebug
2. Spegni ogni eventuale DNS-blocker
3. Assicurati che la tua VPN (LocalDevVPN o StikDebug) e Wi-Fi siano connessi
4. Riprova (spammare il bottone a volte aiuta)
5. Riavvia SideStore
6. Riavvia LocalDevVPN o StikDebug
