...
2. Genera e importa un nuovo pairing file utilizzando idevice pair. Vedi le nostre [istruzioni pairing file](/docs/installation/pairing-file) per più dettagli
...
3. Riavvia SideStore
4. Riavvia StosVPN
5. Rigenera e importa un nuovo pairing file utilizzando idevice pair. Vedi le nostre [istruzioni pairing file](/docs/installation/pairing-file) per più dettagli
