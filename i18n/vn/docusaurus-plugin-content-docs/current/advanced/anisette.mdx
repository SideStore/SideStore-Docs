...
```
Máy cần được cung cấp... xong!
Dịch vụ của bạn đang hoạt động 🎉
```

*Nếu bản dựng không thành công vì bất kỳ lý do nào, hãy nhấp vào **Triển khai thủ công**, sau đó **Triển khai cam kết mới nhất**.*
...
*  xuống máy chủ cuối cùng trong danh sách và thêm dấu phẩy sau dấu ngoặc nhọn đóng của máy chủ cuối cùng ('}'), sau đó thêm máy chủ của riêng bạn theo định dạng sau:
```
{
