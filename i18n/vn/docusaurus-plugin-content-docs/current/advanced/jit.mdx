---
title: Chạy JIT
description: Hướng dẫn cách bật Biên dịch Just-in-Time (JIT) cho các ứng dụng yêu cầu tính năng này.
---
...
2. **Tải lên tệp kết nối:**  
   Khi được nhắc, hãy nhập cùng **tệp ghép nối đã giải nén** lấy được qua JitterbugPair mà bạn sử dụng cho SideStore. Để biết thêm thông tin về cách lấy tệp ghép nối này, hãy xem [tại đây](/docs/installation/pairing-file).
