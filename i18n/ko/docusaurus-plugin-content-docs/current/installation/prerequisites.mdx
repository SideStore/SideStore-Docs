...
- [비밀번호가 설정된](https://support.apple.com/en-us/119586) iOS 또는 iPadOS 14 이상을 사용하는 iPhone 또는 iPad
- [Windows](/docs/installation/windows.mdx), [macOS](/docs/installation/mac.mdx), 또는 [Linux (Linux 지원은 실험적입니다)](/docs/installation/linux.mdx) 컴퓨터
- Apple ID
- StosVPN 앱
