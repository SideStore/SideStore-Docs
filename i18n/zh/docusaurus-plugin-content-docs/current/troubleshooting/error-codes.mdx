...
这意味着您的配对文件已损坏。[请使用 iloader 重新导入](/zh/docs/advanced/pairing-file)。
...
您似乎未连接至Wi-Fi和/或StosVPN。SideStore在未连接Wi-Fi和StosVPN的情况下无法刷新或安装应用程序，请确保两者均已连接。若仍无法解决，请[使用iloader重新导入配对文件](/zh/docs/advanced/pairing-file)。
...
请确保Wi-Fi和StosVPN均已连接。若错误仍未解决，请[使用iloader重新导入配对文件](/zh/docs/advanced/pairing-file)。
